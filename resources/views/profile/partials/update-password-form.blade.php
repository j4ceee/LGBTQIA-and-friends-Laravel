<section>
    <header>
        <h2 class="text-lg font-medium text-white">
            {{ __('profile.sections.password_h') }}
        </h2>

        <p class="mt-1 text-sm text-gray-300">
            {{ __('profile.sections.password_d') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('auth.password_current')" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('auth.password_new')" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('auth.password_confirm')" />
